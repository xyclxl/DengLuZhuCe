    ...
    <ul>
        <li>
            <dl>
                ...
                <dd><a href="goodAdmin_home_tianjia.jsp" class="active">商品添加</a></dd>
                <dd><a href="#">商品修改</a></dd>
                <dd><a href="#">商品查询</a></dd>
            </dl>
        </li>
...
<section class="rt_wrap content" style="overflow: scroll">
    <div class="rt_content">
        ...
        <section>
            <form action="/DengLuZhuCe/GoodsAdd" method="post" enctype="multipart/form-data">
                <h2><strong style="color:grey;">商品添加</strong></h2>

                <ul class="ulColumn2">
                    <li>
                        <span class="item_name" style="width:120px;">商品编号：</span>
                        <input type="text" class="textbox textbox_295" placeholder="编号请按顺序" name="goodnum"/>
                        <span class="errorTips">*请按类型填写编号前缀</span>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">商品名称：</span>
                        <input type="text" class="textbox textbox_295" placeholder="名称请写全" name="goodname"/>
                    ...
                    <li>
                        ...
                        <input type="text" class="textbox textbox_295" placeholder="产地注明" name="goodplace"/>
                        <span class="errorTips">*必填项</span>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">价格：</span>
                        <input type="text" class="textbox textbox_295" placeholder="价格注明" name="goodprice"/>
                        <span class="errorTips">*必填项</span>
                    </li>
                    <li>
                        <span class="item_name" style="width:120px;">摘要：</span>
                        <textarea placeholder="摘要信息" class="textarea" style="width:500px;height:100px;" name="gooddescribe"></textarea>
                    </li>
                    <li>
