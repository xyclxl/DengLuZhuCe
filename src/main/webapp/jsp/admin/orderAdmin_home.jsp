...
<%
    ...
    List<OrderInfo> oList=orderDao.selectGoodsByName();
...
<aside class="lt_aside_nav content " style="overflow: scroll">
    ...
    <ul>
        ...
        <li>
            <dl>
                <dt>订单信息</dt>
                <dd><a href="#" class="active">订单列表</a></dd>
                <dd><a href="#">添加订单</a></dd>
                <dd><a href="#">缺货登记</a></dd>
            </dl>
        </li>
...
<section class="rt_wrap content " style="overflow: scroll">
    <div class="rt_content">
        ...
        <div class="page_title">
            <h2 class="fl">所有订单详情</h2>
<%--            <a class="fr top_rt_btn">查询</a>--%>
<%--            <a class="fr top_rt_btn" href="orderAdmin_home_tianjia.jsp">添加</a>--%>
        </div>
        <table class="table">
            <tr>
                <th>编号</th>
            ...
            <c:forEach items="${requestScope.oList}" var="order">
                <tr>
                    ...
                    <td>
                        <a href="/DengLuZhuCe/OrderDelete_adminByid?id=${order.id}" class="inner_btn" id="deletebtn" onclick="javascript:return del()">删除</a>
                        <a href="/DengLuZhuCe/OrderQueryById?id=${order.id}" class="inner2_btn">修改</a>
                    </td>
                </tr>
                <script>
                    function del(){
